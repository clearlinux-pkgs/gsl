...
Source0  : https://mirrors.kernel.org/gnu/gsl/gsl-2.8.tar.gz
Source1  : https://mirrors.kernel.org/gnu/gsl/gsl-2.8.tar.gz.sig
...
%setup -q -n gsl-2.8
cd %{_builddir}/gsl-2.8
pushd ..
cp -a gsl-2.8 buildavx2
popd
pushd ..
cp -a gsl-2.8 buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1717443492
...
%files bin
%defattr(-,root,root,-)
/V3/usr/bin/gsl-histogram
/V3/usr/bin/gsl-randist
/V4/usr/bin/gsl-histogram
/V4/usr/bin/gsl-randist
/usr/bin/gsl-config
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libgsl.so.28.0.0
/V3/usr/lib64/libgslcblas.so.0.0.0
/V4/usr/lib64/libgsl.so.28.0.0
/V4/usr/lib64/libgslcblas.so.0.0.0
/usr/lib64/libgsl.so.28
/usr/lib64/libgsl.so.28.0.0
